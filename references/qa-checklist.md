...
- When requested, does the asset list include a social media avatar?
...
- Social media avatar stays recognizable when square-cropped, circular-cropped, and viewed small when requested.
